...
/**
 * The primary key class for the WARNING_HIST database table.
 * 
 */
@Embeddable
public class WarningHistPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof WarningHistPK)) {
			return false;
		}
		WarningHistPK castOther = (WarningHistPK)other;
		return 
