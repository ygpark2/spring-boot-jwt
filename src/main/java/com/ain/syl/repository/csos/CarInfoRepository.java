...
import com.ain.syl.domain.csos.CarInfo;
import com.ain.syl.domain.csos.CarInfoPK;
 ...
 */
@Repository
public interface CarInfoRepository extends CrudRepository<CarInfo, CarInfoPK>, QueryDslPredicateExecutor<CarInfo> {
