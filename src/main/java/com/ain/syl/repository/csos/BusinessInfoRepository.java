...
import com.ain.syl.domain.csos.BusinessInfo;
 ...
 */
@Repository
public interface BusinessInfoRepository extends CrudRepository<BusinessInfo, Integer>, QueryDslPredicateExecutor<BusinessInfo> {
